...
for entry in control-plane:/app/service trace-service:/app/service graph-service:/app/service runtime-gateway:/app/service \
...
for svc in trace-service graph-service runtime-gateway; do
